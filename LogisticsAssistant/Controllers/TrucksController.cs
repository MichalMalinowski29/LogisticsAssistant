...
namespace LogisticsAssistant.Controllers
{
    public class TrucksController : Controller
    {
        ...
        public TrucksController(LogisticsAssistantContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Truck != null ? 
                          ...
                          Problem("Entity set 'LogisticsAssistantContext.Truck'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,truckId,vMax,breakRequired")] Truck truck)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,truckId,vMax,breakRequired")] Truck truck)
        {
            if (id != truck.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LogisticsAssistantContext.Truck'  is null.");
            }
            var truck = await _context.Truck.FindAsync(id);
            if (truck != null)
            {
